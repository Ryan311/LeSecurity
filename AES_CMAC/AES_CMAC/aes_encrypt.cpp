...
void AesEncrypt(
	unsigned long KeyLen,	// KeyLen = 128, 192, 256
	unsigned char *pKey,
...
{
	AesEncrypt(128, pKey, pPlainTextData, pEncryptedData);
}
...
{
	AesEncrypt(192, pKey, pPlainTextData, pEncryptedData);
}
...
{
	AesEncrypt(256, pKey, pPlainTextData, pEncryptedData);
}
...
{
	//unsigned char key[16] = {0x00,0xE0,0x4C,0x23,0x47,0xE7,0x42,0x5B,0xBF,0x8F,0xFD,0xD4,0xFF,0xFF,0x00,0x00};
	//unsigned char plainData[16] = {0x12,0x34,0x56,0x78,0x9A,0xBC,0xDE,0xFF,0xFF,0xED,0xCB,0xA9,0x87,0x65,0x43,0x21};
	unsigned char key[16] = { 0x00, 0x01, 0x02, 0x03, 0x04 ,0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
	unsigned char plainData[16] = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff };
	unsigned char out[16];

	printf("--------------------------------------------------\n");
	printf("K              "); print128(key); printf("\n");
	printf("Raw Data       "); print128(plainData); printf("\n");
	AesEncrypt(128, key, plainData, out);
	printf("\nAES_128        "); print128(out); printf("\n");
	printf("--------------------------------------------------\n");
}